...
- Ecosystem docs: compiler canonical repo is **`lic`** (`li-language` deprecated note) — [2026-05-25-overview-lic-wp-a5.md](docs/release-notes/2026-05-25-overview-lic-wp-a5.md) (WP-A5)
