...
**li-langverse org** · scanned **2026-06-14T13:31Z** · gitlab snapshot · live queue via status.json

| Metric | Value |
|--------|------:|
| Open issues (GitLab) | 90 |
...
2. [li-os #6](https://gitlab.lilangverse.xyz/li-langverse/li-os/-/merge_requests/6) — feat(kernel): LiOS all-ms-real — 14 phases without --stub (li-os)
3. [li-research-ingest #1](https://gitlab.lilangverse.xyz/li-langverse/li-research-ingest/-/merge_requests/1) — fix(research): R1b ingest state blocker diagnostics + S2 key gate verifi
4. [lic #304](https://gitlab.lilangverse.xyz/li-langverse/lic/-/merge_requests/304) — proof-explorer(phase15): honest catalog prove — Erdős terminal sweep
5. [lic #348](https://gitlab.lilangverse.xyz/li-langverse/lic/-/merge_requests/348) — feat(kernel): LiOS all-ms-real — 14 phases without --stub (lic)
6. [lic #349](https://gitlab.lilangverse.xyz/li-langverse/lic/-/merge_requests/349) — docs(guide): extend getting-started CLI table with agent/proof commands
...
|----------|-------|-----|--------|-------|
| P0 | [li-browser#1](https://gitlab.lilangverse.xyz/li-langverse/li-browser/-/merge_requests/1) | pass | Merge when approved | snapshot 2026-06-14T13:31Z |
| P0 | [li-os#6](https://gitlab.lilangverse.xyz/li-langverse/li-os/-/merge_requests/6) | pass | Merge when approved | snapshot 2026-06-14T13:31Z |
| P0 | [li-research-ingest#1](https://gitlab.lilangverse.xyz/li-langverse/li-research-ingest/-/merge_requests/1) | pass | Merge when approved | snapshot 2026-06-14T13:31Z |
| P0 | [lic#304](https://gitlab.lilangverse.xyz/li-langverse/lic/-/merge_requests/304) | pass | Merge when approved | snapshot 2026-06-14T13:31Z |
| P0 | [lic#348](https://gitlab.lilangverse.xyz/li-langverse/lic/-/merge_requests/348) | pass | Merge when approved | snapshot 2026-06-14T13:31Z |
| P0 | [lic#349](https://gitlab.lilangverse.xyz/li-langverse/lic/-/merge_requests/349) | pass | Merge when approved | snapshot 2026-06-14T13:31Z |
| P0 | [lit#7](https://gitlab.lilangverse.xyz/li-langverse/lit/-/merge_requests/7) | pass | Merge when approved | snapshot 2026-06-14T13:31Z |
| P0 | [lit#9](https://gitlab.lilangverse.xyz/li-langverse/lit/-/merge_requests/9) | pass | Merge when approved | snapshot 2026-06-14T13:31Z |
| P0 | [lit#11](https://gitlab.lilangverse.xyz/li-langverse/lit/-/merge_requests/11) | pass | Merge when approved | snapshot 2026-06-14T13:31Z |
| P0 | [lit#12](https://gitlab.lilangverse.xyz/li-langverse/lit/-/merge_requests/12) | pass | Merge when approved | snapshot 2026-06-14T13:31Z |
| P0 | [lit#13](https://gitlab.lilangverse.xyz/li-langverse/lit/-/merge_requests/13) | pass | Merge when approved | snapshot 2026-06-14T13:31Z |
| P0 | [lit#15](https://gitlab.lilangverse.xyz/li-langverse/lit/-/merge_requests/15) | pass | Merge when approved | snapshot 2026-06-14T13:31Z |
| P0 | [lit#16](https://gitlab.lilangverse.xyz/li-langverse/lit/-/merge_requests/16) | pass | Merge when approved | snapshot 2026-06-14T13:31Z |
...
| li-os | 6 | [feat(kernel): LiOS all-ms-real — 14 phases without --stub (li-os)](https://gitlab.lilangverse.xyz/li-langverse/li-os/-/merge_requests/6) | main | pass | yes |
...
| lic | 344 | [chore(libernetes): wire Wave 9 VM metrics gate on livm track](https://gitlab.lilangverse.xyz/li-langverse/lic/-/merge_requests/344) | main | none | no |
| lic | 347 | [feat(libernetes/control): Wave 9 cluster ops docs + dashboard (LB-K26–…](https://gitlab.lilangverse.xyz/li-langverse/lic/-/merge_requests/347) | main | none | no |
| lic | 348 | [feat(kernel): LiOS all-ms-real — 14 phases without --stub (lic)](https://gitlab.lilangverse.xyz/li-langverse/lic/-/merge_requests/348) | main | pass | yes |
| lic | 349 | [docs(guide): extend getting-started CLI table with agent/proof command…](https://gitlab.lilangverse.xyz/li-langverse/lic/-/merge_requests/349) | main | pass | yes |
...
| roadmap | 4 | [docs(roadmap): fix README UTF-8 mojibake (em dashes)](https://gitlab.lilangverse.xyz/li-langverse/roadmap/-/merge_requests/4) | main | none | no |
